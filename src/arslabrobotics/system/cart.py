...
class TwoWheelsCart2DEncoders(TwoWheelsCart2D):
    ...
    def __init__(self, _mass, _radius, _lin_friction, _ang_friction,
        ...
        :param _lin_friction: The force of linear friction present in the system
        :param _ang_friction: The force of angular friction present in the system
        :param _r_traction_left: The radius of the left traction wheel (meters)
        :param _r_traction_right: The radius of the right traction wheel (meters)
        :param _traction_wheelbase: The distance between the traction wheels, expressed in meters
        :param _r_encoder_left: The radius of the left encoder wheel (meters)
